...
namespace ParserLib.Parsing.Rules
{
	...
	public sealed class CharRule : Rule
	{
		...
		/// <exception cref="ParserException">new InvalidOperationException("Position is longer than input string (end of string has been reached)")</exception>
		/// <exception cref="System.InvalidOperationException">Position is longer than input string (end of string has been reached)</exception>
